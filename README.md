...
## MAX POWER!
You can squeeze some more power out of my hash cracking by adding these parameters:
```
...
I typically drop OneRuleToRuleThemAll.rule into the rules subfolder and run it like this from my pc (based on the notsosecure article):
```
...
```
*Benchmark using a Nvidia 3090 GTX:*
Speed: 12000 MH/s
Recovery Rate: 12.47%
...
Based on my benchmarking, KRB5TGS cracking is lot slower than NTLM.
